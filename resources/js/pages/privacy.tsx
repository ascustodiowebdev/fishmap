...
const content = {
    en: {
        ...
        intro: 'NautiBite is a fishing logbook and navigation aid. It can help you record fish spots, routes, and live GPS guidance, but it is not an official nautical chart, certified navigation system, rescue service, or substitute for safe seamanship.',
        back: 'Back to NautiBite',
        sections: [
            {
                icon: ShieldCheck,
                title: 'Privacy and account data',
                body: [
                    'When you create or use an account, NautiBite may store your name, email, authentication data, app preferences, and saved content such as fish spots, notes, photos or photo links, route names, privacy settings, and timestamps.',
                    'Private spots and private routes are intended to be visible only to your account. Public spots or public routes may be visible to other NautiBite users, including their names, coordinates, timestamps, and any details you choose to publish.',
                ],
            },
            {
                icon: MapPinned,
                ...
                body: [
                    'If you enable location, NautiBite uses GPS or device location services to show your current position, speed, heading, maximum speed, and route guidance. When you record a route, NautiBite stores route points with latitude, longitude, and time.',
            ...
            },
            {
                ...
                body: [
                    'NautiBite may request weather, wind, tide, and map data from external providers. These services may receive approximate coordinates, request metadata, or other technical information required to return the data.',
            ...
            },
            {
                ...
                body: [
                    ...
                    'By using NautiBite, you accept that navigation decisions remain your responsibility. NautiBite and its operators are not responsible for accidents, groundings, collisions, loss of equipment, personal injury, data loss, missed catches, fines, damages, or other losses resulting from use of the app or reliance on its information.',
                    'In an emergency, use official emergency channels and equipment. Do not rely on NautiBite as an emergency or rescue service.',
                ],
            },
        ],
    },
    pt: {
        ...
        intro: 'O NautiBite é um diário de pesca e uma ajuda à navegação. Pode ajudar-te a guardar fish spots, rotas e guidance GPS em direto, mas não é uma carta náutica oficial, sistema certificado de navegação, serviço de emergência, nem substitui uma navegação prudente.',
        back: 'Voltar ao NautiBite',
        sections: [
            {
                icon: ShieldCheck,
                title: 'Privacidade e dados da conta',
                body: [
                    'Quando crias ou usas uma conta, o NautiBite pode guardar o teu nome, email, dados de autenticação, preferências da app e conteúdo guardado, incluindo fish spots, notas, fotos ou links de fotos, nomes de rotas, definições de privacidade e datas/horas.',
                    'Fish spots e rotas privadas destinam-se a ficar visíveis apenas na tua conta. Fish spots ou rotas públicas podem ficar visíveis para outros utilizadores do NautiBite, incluindo nomes, coordenadas, datas/horas e detalhes que escolhas publicar.',
                ],
            },
            {
                icon: MapPinned,
                ...
                body: [
                    'Se ativares a localização, o NautiBite usa GPS ou os serviços de localização do dispositivo para mostrar posição atual, velocidade, rumo, velocidade máxima e guidance de rota. Quando gravas uma rota, o NautiBite guarda pontos de rota com latitude, longitude e hora.',
            ...
            },
            {
                ...
                body: [
                    'O NautiBite pode pedir dados de meteorologia, vento, marés e mapas a fornecedores externos. Esses serviços podem receber coordenadas aproximadas, metadados do pedido ou outra informação técnica necessária para devolver os dados.',
            ...
            },
            {
                ...
                body: [
                    ...
                    'Ao usar o NautiBite, aceitas que as decisões de navegação são da tua responsabilidade. O NautiBite e os seus responsáveis não se responsabilizam por acidentes, encalhes, colisões, perda de equipamento, ferimentos, perda de dados, capturas perdidas, multas, danos ou outros prejuízos resultantes do uso da app ou da confiança na informação apresentada.',
                    'Em emergência, usa canais e equipamentos oficiais de emergência. Não uses o NautiBite como serviço de emergência ou salvamento.',
                ],
            },
        ],
    },
            ...
            <div className="min-h-screen bg-[#f5fbfc] text-slate-950">
                <div className="mx-auto flex min-h-screen max-w-5xl flex-col px-4 py-5 sm:px-6 lg:px-8">
                    ...
                    <main className="py-8 sm:py-12">
                        ...
                        <h1 className="mt-4 max-w-3xl text-3xl leading-tight font-semibold tracking-tight text-slate-950 sm:text-5xl">
                            {page.title}
                        </h1>

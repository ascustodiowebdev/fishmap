...
const content = {
    en: {
        ...
        intro: 'TidePilot is a fishing logbook and navigation aid. It can help you record fish spots, routes, and live GPS guidance, but it is not an official nautical chart, certified navigation system, rescue service, or substitute for safe seamanship.',
        back: 'Back to TidePilot',
        sections: [
            {
                icon: ShieldCheck,
                title: 'Privacy and account data',
                body: [
                    'When you create or use an account, TidePilot may store your name, email, authentication data, app preferences, and saved content such as fish spots, notes, photos or photo links, route names, privacy settings, and timestamps.',
                    'Private spots and private routes are intended to be visible only to your account. Public spots or public routes may be visible to other TidePilot users, including their names, coordinates, timestamps, and any details you choose to publish.',
                ],
            },
            {
                icon: MapPinned,
                ...
                body: [
                    'If you enable location, TidePilot uses GPS or device location services to show your current position, speed, heading, maximum speed, and route guidance. When you record a route, TidePilot stores route points with latitude, longitude, and time.',
            ...
            },
            {
                ...
                body: [
                    'TidePilot may request weather, wind, tide, and map data from external providers. These services may receive approximate coordinates, request metadata, or other technical information required to return the data.',
            ...
            },
            {
                ...
                body: [
                    ...
                    'By using TidePilot, you accept that navigation decisions remain your responsibility. TidePilot and its operators are not responsible for accidents, groundings, collisions, loss of equipment, personal injury, data loss, missed catches, fines, damages, or other losses resulting from use of the app or reliance on its information.',
                    'In an emergency, use official emergency channels and equipment. Do not rely on TidePilot as an emergency or rescue service.',
                ],
            },
        ],
    },
    pt: {
        ...
        intro: 'O TidePilot é um diário de pesca e uma ajuda à navegação. Pode ajudar-te a guardar fish spots, rotas e guidance GPS em direto, mas não é uma carta náutica oficial, sistema certificado de navegação, serviço de emergência, nem substitui uma navegação prudente.',
        back: 'Voltar ao TidePilot',
        sections: [
            {
                icon: ShieldCheck,
                title: 'Privacidade e dados da conta',
                body: [
                    'Quando crias ou usas uma conta, o TidePilot pode guardar o teu nome, email, dados de autenticação, preferências da app e conteúdo guardado, incluindo fish spots, notas, fotos ou links de fotos, nomes de rotas, definições de privacidade e datas/horas.',
                    'Fish spots e rotas privadas destinam-se a ficar visíveis apenas na tua conta. Fish spots ou rotas públicas podem ficar visíveis para outros utilizadores do TidePilot, incluindo nomes, coordenadas, datas/horas e detalhes que escolhas publicar.',
                ],
            },
            {
                icon: MapPinned,
                ...
                body: [
                    'Se ativares a localização, o TidePilot usa GPS ou os serviços de localização do dispositivo para mostrar posição atual, velocidade, rumo, velocidade máxima e guidance de rota. Quando gravas uma rota, o TidePilot guarda pontos de rota com latitude, longitude e hora.',
            ...
            },
            {
                ...
                body: [
                    'O TidePilot pode pedir dados de meteorologia, vento, marés e mapas a fornecedores externos. Esses serviços podem receber coordenadas aproximadas, metadados do pedido ou outra informação técnica necessária para devolver os dados.',
            ...
            },
            {
                ...
                body: [
                    ...
                    'Ao usar o TidePilot, aceitas que as decisões de navegação são da tua responsabilidade. O TidePilot e os seus responsáveis não se responsabilizam por acidentes, encalhes, colisões, perda de equipamento, ferimentos, perda de dados, capturas perdidas, multas, danos ou outros prejuízos resultantes do uso da app ou da confiança na informação apresentada.',
                    'Em emergência, usa canais e equipamentos oficiais de emergência. Não uses o TidePilot como serviço de emergência ou salvamento.',
                ],
            },
        ],
    },
